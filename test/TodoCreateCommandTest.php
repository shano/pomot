...
/**
 * TodoCreateCommandTest
 *
 */
class TodoCreateCommandTest extends \PHPUnit_Framework_TestCase
{
    /**
  ...
  "manual": false
        ...
        $application->add(new TodoCreateCommand($pomotodoQuery));
        $command = $application->find('todo:create');
        $tester = new CommandTester($command);
        $tester->execute(
            ['command' => $command->getName(), 'description'=>'Test Description']
        );
        $result = "Your todo 'Hello Pomotodo!' was created.\n";
